...
This library allow the user to create a .bmp files representing
simple images.
...
and after the manifest g_bdrawbase has been declared if the default
value declared in libhdr is not suitable. This library uses region of
the global vector from g_bdrawbase upwards.
...
{ // Draw a unit square ie a pixel at (x,y) with colour currcol
  // provided that it is in range.
  // (0,0) is the position of the bottom left hand pixel
...
{ LET xl, xc, xr = 0, 0, 0
  ...
  { DEFAULT: writef("Bad direction %n for arrow*n", dir)
    ...
    CASE 0: moveto(x,y); drawby(-len,  len/3)   // Left side
	    moveto(x,y); drawby(-len, -len/3)   // Right side
	    RETURN

    CASE 1: moveto(x,y); drawby(-len/3, -len)   // Left side
	    moveto(x,y); drawby( len/3, -len)   // Right side
	    RETURN

    CASE 2: moveto(x,y); drawby( len, -len/3)   // Left side
	    moveto(x,y); drawby( len,  len/3)   // Right side
	    RETURN

    CASE 3: moveto(x,y); drawby(-len/3,  len)   // Left side
	    moveto(x,y); drawby( len/3,  len)   // Right side
	    RETURN
  }
}
...
{  charLmargin := 10
  ...
  writef("Bad argument for fontselect, h=%n*n", h)
  abort(999)
}
...
{ // Writes the horizontal slice of the given 24x16 character.
  ...
  LET bitmap = offset + TABLE
	 ...
	 // in BCPL words
      ...
      #b_0_0_0_0_1_1_1_1_1_1_1_1_1_1_1_1_1_1_0_0_0_0_0_0,
      #b_0_0_1_1_1_1_1_1_1_1_1_0_0_0_0_0_0_0_0_0_0_0_0_0,
      #b_0_1_1_1_1_1_0_0_1_1_1_0_0_0_0_0_0_0_0_0_0_0_0_0,
      #b_0_1_1_1_0_0_0_0_1_1_1_0_0_0_0_0_0_0_0_0_0_0_0_0,
      #b_1_1_1_0_0_0_0_0_1_1_1_0_0_0_0_0_0_0_0_0_0_0_0_0,
      #b_1_1_1_0_0_0_0_0_1_1_1_0_0_0_0_0_0_0_0_0_0_0_0_0,  //==
      #b_1_1_1_0_0_0_0_0_1_1_1_0_0_0_0_0_0_0_0_0_0_0_0_0,  //==
      #b_1_1_1_0_0_0_0_0_1_1_1_0_0_0_0_0_0_0_0_0_0_0_0_0,
...
{ // Draw a vertical curly bracket starting between
  ...
  FOR i = 1 TO len BY 2 DO
    v!i, v!(i+1) := x+shape!(i+1)*xs/200, y+shape!i*ys/100
  drawsmooth(v)

  FOR i = 1 TO len BY 2 DO
    v!i, v!(i+1) := x+shape!(i+1)*xs/200, y+(2*100-shape!i)*ys/100
  drawsmooth(v)
...
{ LET pxlen = strpixels(text)
  ...
  LET w = pxlen+2*ew
  LET x1, x2 = x, x+w
  LET y1, y2 = y-fontH*8/10, y+fontH*8/10
