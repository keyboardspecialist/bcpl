...
{ LET g, p = 0, 0
  ...
  writef("*nBCPL %n-bit Cintcode System (6 Sep 2019)*n", BITSPERBCPLWORD)
...
sw:
  ...
  { DEFAULT: error()
    ...
    CASE '?':
       ...
       writes("$b $c $d $e $f $o $e $s $u $x Set the print style*n")
